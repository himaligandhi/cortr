...
<nav class="navbar navbar-expand-sm navbar-dark" style="margin-bottom: 15px;">
   <div class="container-fluid" style="border-top:0.5px solid #44444C; border-bottom: 0.5px solid #44444C;background-color: #ececed;">
    ...
    <h1 style="margin-top: 0;"><u>CONTACT US</u></h1>
    <div class="container">
        <div class="row" style="margin-top: 80px;">
            <div class="col-sm-6">
          
                <form class="cf" method="post" action="mail.php" name="contact_form">
                <span id="formerror" class="error"></span>
                    <div class="half left cf">
                        ...
                        <textarea type="text" id="input-message" name="message" placeholder="Message" name="message" ></textarea>
